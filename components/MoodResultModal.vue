<template>
  <UModal v-model="isOpen">
    <UCard>
      <template #header>
        <h3 class="font-semibold">Интерпретация результатов опросника</h3>
      </template>
      ...
      <div>
        <div class="mb-4">
          ...
          <div v-if="moodEntry.suicidal_1 >= 1">
            ...
            не
            строите конкретных планов действий. Однако будет мудрым решением проконсультироваться со специалистом в
            области психического здоровья, если у вас возникают суицидальные фантазии или импульсы, или если чувства
