<template>
  <UModal v-model="isOpen">
    <UCard>
      <template #header>
        <div class=" font-bold text-xl">Опрос настроения</div>
        <div>Выберите от 0 до 5</div>
      </template>
