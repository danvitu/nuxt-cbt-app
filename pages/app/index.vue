<template>
  ...
  <section class="mb-12">
    ...
    <div class="grid grid-cols-5 sm:font-semibold sm:text-base text-xs pb-4">
    ...
    <div v-else-if="moodEntries.length === 0">У вас нет записей в опроснике. Нажмите на кнопку "Опрос", чтобы добавить.
    </div>
    <template v-else>
  ...
  <section class="mb-12">
    ...
    <div class="grid grid-cols-5 font-semibold pb-4">
      <div>Дата</div>
